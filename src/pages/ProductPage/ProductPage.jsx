        ...
        <div className="flex flex-col justify-between lg:flex-row gap-16 lg:items-center my-20 mx-5">
          ...
          <div className="flex flex-col gap-4 lg:w-2/4">
            ...
            <p className="text-white">
              ...
              cumque laboriosam, aliquid consequuntur modi asperiores dolore
              nobis suscipit, deserunt animi repellendus harum iste ducimus et
              quia a eum nemo fugiat!
            </p>
